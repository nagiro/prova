					...
					<div><img src="<?php echo $imatge ?>" style="width:150px; vertical-align:middle" /></div>
						...
						<div style="margin-top:20px; font-size:10px">
                            <div class="requadre_mini" style="background-color:#A2844A;">
                                <a href="javascript:history.back()">&lt; Torna als formularis</a>
                            </div>
                        </div>
                                                                        
                        <?php $url = url_for('@hospici_formularis_detall?idF='.$FORM->getIdformularis().'&titol='.$FORM->getNomForUrl()); ?>
                        <?php if( isset($AUTH) && $AUTH > 0 ): ?>                                                                           
                            <div style="margin-top: 5px;">
                                <div class="requadre_mini" style="background-color: #FFCC00;">
                                    <a href="<?php echo $url ?>">Omple formulari</a>
                                </div>
                            </div>                                                                                        
                        <?php else: ?>
                            <div style="margin-top: 5px">
                                <div class="requadre_mini" style="background-color: #FFCC00;">                
                                    <a class="auth" href="<?php echo $url ?>">Autentifica't i omple'l</a>
                                </div>
                            </div>
                        <?php endif; ?>                        
