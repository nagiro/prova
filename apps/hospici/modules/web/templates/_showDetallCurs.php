            					...
            					<div style="padding:10px; font-size:10px;">
                                    ...
                                    <?php
                                        ...
                                        switch($ESTAT){
                                            ...
                                            case 'CURS_INACTIU'     : echo '<div>La matrícula a aquest curs s\'obre el dia '.$CURS->getDatainmatricula('d/m/Y').' a les 9:00 del matí, però de moment és tancada és tancada. <br /><br /> Per a més informació pot posar-se en contacte amb <b>'.$nom.'</b> enviant un correu electrònic a <b>'.$email.'</b> o bé trucant al <b>'.$tel.'</b></div>'; break; 
                                            ...
                                            case 'ANTIC_ALUMNE':    echo 'La matrícula és oberta per a antics alumnes. Vostè podrà matricular-se en el període corresponent. <br /><br /> Per a més informació pot posar-se en contacte amb <b>'.$nom.'</b> enviant un correu electrònic a <b>'.$email.'</b> o bé trucant al <b>'.$tel.'</b>'; break;
                                            case 'ABANS_PERIODE_MATRICULA': echo '<div>Vostè podrà matricular-se a aquest curs per internet a partir del dia '.$CURS->getDatainmatricula('d/m/Y').' a les 9:00 del matí.<br /><br /> Per a més informació pot posar-se en contacte amb <b>'.$nom.'</b> enviant un correu electrònic a <b>'.$email.'</b> o bé trucant al <b>'.$tel.'</b></div>'; break;
