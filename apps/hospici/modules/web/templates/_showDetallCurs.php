            					...
            					<div style="padding:10px; font-size:10px;">
                                    ...
                                    <?php
                                        ...
                                        switch($ESTAT){
                                            ...
                                            case 'CURS_INACTIU'     : echo '<div>Vostè podrà matricular-se a aquest curs per internet, però de moment la matrícula és tancada. <br /><br /> Per a més informació pot posar-se en contacte amb <b>'.$nom.'</b> enviant un correu electrònic a <b>'.$email.'</b> o bé trucant al <b>'.$tel.'</b></div>'; break; 
