...
<div id="tabs">
    ...
    <form action="<?php echo url_for('@hospici_cercador_activitats')?>" method="POST">
        ...
        <div style="float: left;">
            <div style="margin: 5px;">            
                <b>Quan?</b><br /><?php echo select_tag('cerca[DATA]',options_for_select(ActivitatsPeer::selectDatesActivitats($CERCA['POBLE'][0],$CERCA['CATEGORIA'][0],$CERCA['TEXT']),$CERCA['DATA'][0]), array('multiple'=>'multiple','style'=>'height:130px; width:180px;','id'=>'R_DATA')); ?>
            </div>
        </div>
