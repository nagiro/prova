		...
		case 'caa':
            ...
            $this->getResponse()->addMeta('facebook',
                                    myUser::getFacebookHeaders( $OA->getTmig() , 
                                                                sfConfig::get('sf_webrooturl').$this->getController()->genUrl('@web_activitat?idA='.$OA->getActivitatId().'&titol='.$OA->getNomForUrl()),
	   		...
	   		if($this->IDN > 0):	   			
                ...
                $this->getResponse()->addMeta('facebook',
                    myUser::getFacebookHeaders(
                        ...
                        sfConfig::get('sf_webrooturl').$this->getController()->genUrl('@web_noticia?idN='.$this->NOTICIA->getIdnoticia().'&p='.$this->PAGINA.'&titol='.$this->NOTICIA->getNomForUrl()),
