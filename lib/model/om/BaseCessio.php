  ...
  const PEER = 'CessioPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->data_cessio = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->data_retorn = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->estat = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->retornat = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->estat_retornat = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->data_retornat = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = CessioPeer::NUM_COLUMNS - CessioPeer::NUM_LAZY_LOAD_COLUMNS).
