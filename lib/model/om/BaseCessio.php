...
abstract class BaseCessio extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->representant = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->motiu = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->condicions = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->material_no_inventariat = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->data_cessio = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->data_retorn = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->estat = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->retornat = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->estat_retornat = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->data_retornat = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->site_id = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->actiu = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
			$this->resetModified();
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getNom(),
			$keys[3] => $this->getDni(),
			$keys[4] => $this->getRepresentant(),
			$keys[5] => $this->getMotiu(),
			$keys[6] => $this->getCondicions(),
			$keys[7] => $this->getMaterialNoInventariat(),
			$keys[8] => $this->getDataCessio(),
			$keys[9] => $this->getDataRetorn(),
			$keys[10] => $this->getEstat(),
			$keys[11] => $this->getRetornat(),
			$keys[12] => $this->getEstatRetornat(),
			$keys[13] => $this->getDataRetornat(),
			$keys[14] => $this->getSiteId(),
			$keys[15] => $this->getActiu(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setRepresentant($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setMotiu($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setCondicions($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setMaterialNoInventariat($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setDataCessio($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setDataRetorn($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setEstat($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setRetornat($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setEstatRetornat($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setDataRetornat($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setSiteId($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setActiu($arr[$keys[15]]);
	}
