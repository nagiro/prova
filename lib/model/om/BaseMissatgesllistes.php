...
abstract class BaseMissatgesllistes extends BaseObject  implements Persistent {
  ...
  const PEER = 'MissatgesllistesPeer';
	...
	public function setTitol($v)
	{
		...
		if ($this->titol !== $v) {
			$this->titol = $v;
			$this->modifiedColumns[] = MissatgesllistesPeer::TITOL;
		}
	...
	public function setText($v)
	{
		...
		if ($this->text !== $v) {
			$this->text = $v;
			$this->modifiedColumns[] = MissatgesllistesPeer::TEXT;
		}
	...
	public function setDate($v)
	{
		...
		if ( $this->date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = MissatgesllistesPeer::DATE;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->enviat = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = MissatgesllistesPeer::NUM_COLUMNS - MissatgesllistesPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setIdmissatgesllistes($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setEnviat($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MissatgesllistesPeer::TITOL)) $criteria->add(MissatgesllistesPeer::TITOL, $this->titol);
		if ($this->isColumnModified(MissatgesllistesPeer::TEXT)) $criteria->add(MissatgesllistesPeer::TEXT, $this->text);
		if ($this->isColumnModified(MissatgesllistesPeer::DATE)) $criteria->add(MissatgesllistesPeer::DATE, $this->date);
	...
	/**
	 * Generic method to set the primary key (idmissatgesllistes column).
	 *
	...
	{
		$this->setIdmissatgesllistes($key);
	}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdmissatgesllistes(NULL); // this is a auto-increment column, so set to default value
