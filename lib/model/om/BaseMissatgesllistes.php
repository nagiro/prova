...
/**
 * Base class that represents a row from the 'missatges_llistes' table.
 *
 * 
 *
...
abstract class BaseMissatgesLlistes extends BaseObject  implements Persistent {
	...
	public function setIdllistes($v)
	{
		...
		if ($this->idllistes !== $v) {
			$this->idllistes = $v;
			$this->modifiedColumns[] = MissatgesLlistesPeer::IDLLISTES;
		}
	...
	public function setIdemail($v)
	{
		...
		if ($this->idemail !== $v) {
			$this->idemail = $v;
			$this->modifiedColumns[] = MissatgesLlistesPeer::IDEMAIL;
		}
	...
	public function setSiteId($v)
	{
		...
		if ($this->site_id !== $v || $this->isNew()) {
			$this->site_id = $v;
			$this->modifiedColumns[] = MissatgesLlistesPeer::SITE_ID;
		}
	...
	public function setActiu($v)
	{
		...
		if ($this->actiu !== $v || $this->isNew()) {
			$this->actiu = $v;
			$this->modifiedColumns[] = MissatgesLlistesPeer::ACTIU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = MissatgesLlistesPeer::NUM_COLUMNS - MissatgesLlistesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MissatgesLlistesPeer::IDLLISTES)) $criteria->add(MissatgesLlistesPeer::IDLLISTES, $this->idllistes);
		if ($this->isColumnModified(MissatgesLlistesPeer::IDEMAIL)) $criteria->add(MissatgesLlistesPeer::IDEMAIL, $this->idemail);
		if ($this->isColumnModified(MissatgesLlistesPeer::ENVIAT)) $criteria->add(MissatgesLlistesPeer::ENVIAT, $this->enviat);
		if ($this->isColumnModified(MissatgesLlistesPeer::SITE_ID)) $criteria->add(MissatgesLlistesPeer::SITE_ID, $this->site_id);
		if ($this->isColumnModified(MissatgesLlistesPeer::ACTIU)) $criteria->add(MissatgesLlistesPeer::ACTIU, $this->actiu);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MissatgesLlistesPeer::IDLLISTES, $this->idllistes);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdllistes($this->idllistes);
