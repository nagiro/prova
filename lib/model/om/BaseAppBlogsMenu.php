...
abstract class BaseAppBlogsMenu extends BaseObject  implements Persistent {
	...
	public function setSiteId($v)
	{
		...
		if ($this->site_id !== $v) {
			$this->site_id = $v;
			$this->modifiedColumns[] = AppBlogsMenuPeer::SITE_ID;
		}
	...
	public function setActiu($v)
	{
		...
		if ($this->actiu !== $v || $this->isNew()) {
			$this->actiu = $v;
			$this->modifiedColumns[] = AppBlogsMenuPeer::ACTIU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = AppBlogsMenuPeer::NUM_COLUMNS - AppBlogsMenuPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AppBlogsMenuPeer::SITE_ID)) $criteria->add(AppBlogsMenuPeer::SITE_ID, $this->site_id);
		if ($this->isColumnModified(AppBlogsMenuPeer::ACTIU)) $criteria->add(AppBlogsMenuPeer::ACTIU, $this->actiu);
