...
abstract class BaseCicles extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the extingit field.
	...
	/**
	 * Initializes internal state of BaseCicles object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [extingit] column value.
	 * 
	 * @return     int
	 */
	public function getExtingit()
	{
		return $this->extingit;
	}
	...
	/**
	 * Set the value of [extingit] column.
	 * 
	 * @param      int $v new value
	 * @return     Cicles The current object (for fluent API support)
	 */
	public function setExtingit($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->extingit !== $v || $this->isNew()) {
			$this->extingit = $v;
			$this->modifiedColumns[] = CiclesPeer::EXTINGIT;
		}
	...
	public function setVisibleweb($v)
	{
		...
		if ($this->visibleweb !== $v || $this->isNew()) {
			$this->visibleweb = $v;
			$this->modifiedColumns[] = CiclesPeer::VISIBLEWEB;
		}
	...
	public function setSiteId($v)
	{
		...
		if ($this->site_id !== $v || $this->isNew()) {
			$this->site_id = $v;
			$this->modifiedColumns[] = CiclesPeer::SITE_ID;
		}
	...
	public function setActiu($v)
	{
		...
		if ($this->actiu !== $v || $this->isNew()) {
			$this->actiu = $v;
			$this->modifiedColumns[] = CiclesPeer::ACTIU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->extingit = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->visibleweb = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->site_id = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
			$this->actiu = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->resetModified();
			...
			return $startcol + 14; // 14 = CiclesPeer::NUM_COLUMNS - CiclesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[10] => $this->getExtingit(),
			$keys[11] => $this->getVisibleweb(),
			$keys[12] => $this->getSiteId(),
			$keys[13] => $this->getActiu(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setExtingit($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setVisibleweb($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setSiteId($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setActiu($arr[$keys[13]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CiclesPeer::EXTINGIT)) $criteria->add(CiclesPeer::EXTINGIT, $this->extingit);
		if ($this->isColumnModified(CiclesPeer::VISIBLEWEB)) $criteria->add(CiclesPeer::VISIBLEWEB, $this->visibleweb);
		if ($this->isColumnModified(CiclesPeer::SITE_ID)) $criteria->add(CiclesPeer::SITE_ID, $this->site_id);
		if ($this->isColumnModified(CiclesPeer::ACTIU)) $criteria->add(CiclesPeer::ACTIU, $this->actiu);
