  ...
  const PEER = 'CiclesPeer';
	...
	public function setDescripcio($v)
	{
		...
		if ($this->descripcio !== $v) {
			$this->descripcio = $v;
			$this->modifiedColumns[] = CiclesPeer::DESCRIPCIO;
		}
	...
	public function setBaixa($v)
	{
		...
		if ($this->baixa !== $v) {
			$this->baixa = $v;
			$this->modifiedColumns[] = CiclesPeer::BAIXA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->baixa = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = CiclesPeer::NUM_COLUMNS - CiclesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CiclesPeer::DESCRIPCIO)) $criteria->add(CiclesPeer::DESCRIPCIO, $this->descripcio);
		if ($this->isColumnModified(CiclesPeer::BAIXA)) $criteria->add(CiclesPeer::BAIXA, $this->baixa);
