...
abstract class BaseUsuaris extends BaseObject  implements Persistent {
  ...
  const PEER = 'UsuarisPeer';
	 ...
	 */
	protected $collTasquessRelatedByQuimana;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTasquessRelatedByQuimana.
	 */
	private $lastTasquesRelatedByQuimanaCriteria = null;

	/**
	 * @var        array Tasques[] Collection to store aggregation of Tasques objects.
	 */
	protected $collTasquessRelatedByQuifa;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTasquessRelatedByQuifa.
	 */
	private $lastTasquesRelatedByQuifaCriteria = null;
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 16; // 16 = UsuarisPeer::NUM_COLUMNS - UsuarisPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collTasquessRelatedByQuimana = null;
			$this->lastTasquesRelatedByQuimanaCriteria = null;

			$this->collTasquessRelatedByQuifa = null;
			$this->lastTasquesRelatedByQuifaCriteria = null;
	...
	public function getPoblacions(PropelPDO $con = null)
	{
		if ($this->aPoblacions === null && ($this->poblacio !== null)) {
			$c = new Criteria(PoblacionsPeer::DATABASE_NAME);
			$c->add(PoblacionsPeer::IDPOBLACIO, $this->poblacio);
			$this->aPoblacions = PoblacionsPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function countAppDocumentsPermisoss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collAppDocumentsPermisoss === null) {
			if ($this->isNew()) {
				...
				$count = AppDocumentsPermisosPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Usuaris has previously been saved, it will retrieve
	 * related Fitxerss from storage. If this Usuaris is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFitxerss === null) {
			if ($this->isNew()) {
			   $this->collFitxerss = array();
				...
				$criteria->add(FitxersPeer::USUARIS_IDUSUARI, $this->usuariid);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Usuaris has previously been saved, it will retrieve
	 * related Fitxerscomentariss from storage. If this Usuaris is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFitxerscomentariss === null) {
			if ($this->isNew()) {
			   $this->collFitxerscomentariss = array();
				...
				$criteria->add(FitxerscomentarisPeer::USUARIS_IDUSUARI, $this->usuariid);
	...
	public function countIncidenciessRelatedByQuiinforma(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collIncidenciessRelatedByQuiinforma === null) {
			if ($this->isNew()) {
				...
				$count = IncidenciesPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function countMatriculess(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collMatriculess === null) {
			if ($this->isNew()) {
				...
				$count = MatriculesPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function countMissatgess(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collMissatgess === null) {
			if ($this->isNew()) {
				...
				$count = MissatgesPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function countReservaespaiss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collReservaespaiss === null) {
			if ($this->isNew()) {
				...
				$count = ReservaespaisPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Clears out the collTasquessRelatedByQuimana collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addTasquessRelatedByQuimana()
	 */
	public function clearTasquessRelatedByQuimana()
	{
		$this->collTasquessRelatedByQuimana = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTasquessRelatedByQuimana collection (array).
	 *
	 * By default this just sets the collTasquessRelatedByQuimana collection to an empty array (like clearcollTasquessRelatedByQuimana());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTasquessRelatedByQuimana()
	{
		$this->collTasquessRelatedByQuimana = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Usuaris has previously been saved, it will retrieve
	 * related TasquessRelatedByQuimana from storage. If this Usuaris is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getTasquessRelatedByQuimana($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsuarisPeer::DATABASE_NAME);
		}
		...
		if ($this->collTasquessRelatedByQuimana === null) {
			if ($this->isNew()) {
			   $this->collTasquessRelatedByQuimana = array();
				...
				$criteria->add(TasquesPeer::QUIMANA, $this->usuariid);

				TasquesPeer::addSelectColumns($criteria);
				$this->collTasquessRelatedByQuimana = TasquesPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				TasquesPeer::addSelectColumns($criteria);
				if (!isset($this->lastTasquesRelatedByQuimanaCriteria) || !$this->lastTasquesRelatedByQuimanaCriteria->equals($criteria)) {
					$this->collTasquessRelatedByQuimana = TasquesPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTasquesRelatedByQuimanaCriteria = $criteria;
		return $this->collTasquessRelatedByQuimana;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countTasquessRelatedByQuimana(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsuarisPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collTasquessRelatedByQuimana === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastTasquesRelatedByQuimanaCriteria) || !$this->lastTasquesRelatedByQuimanaCriteria->equals($criteria)) {
					...
					$count = count($this->collTasquessRelatedByQuimana);
				}
			} else {
				$count = count($this->collTasquessRelatedByQuimana);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addTasquesRelatedByQuimana(Tasques $l)
	{
		if ($this->collTasquessRelatedByQuimana === null) {
			$this->initTasquessRelatedByQuimana();
		}
		if (!in_array($l, $this->collTasquessRelatedByQuimana, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTasquessRelatedByQuimana, $l);
			$l->setUsuarisRelatedByQuimana($this);
		}
	}
	 ...
	 * Otherwise if this Usuaris is new, it will return
	 * an empty collection; or if this Usuaris has previously
	 * been saved, it will retrieve related TasquessRelatedByQuimana from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Usuaris.
	 */
	public function getTasquessRelatedByQuimanaJoinActivitats($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsuarisPeer::DATABASE_NAME);
		}
		...
		if ($this->collTasquessRelatedByQuimana === null) {
			if ($this->isNew()) {
				...
				$this->collTasquessRelatedByQuimana = TasquesPeer::doSelectJoinActivitats($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collTasquessRelatedByQuifa collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addTasquessRelatedByQuifa()
	 */
	public function clearTasquessRelatedByQuifa()
	{
		$this->collTasquessRelatedByQuifa = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTasquessRelatedByQuifa collection (array).
	 *
	 * By default this just sets the collTasquessRelatedByQuifa collection to an empty array (like clearcollTasquessRelatedByQuifa());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTasquessRelatedByQuifa()
	{
		$this->collTasquessRelatedByQuifa = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Usuaris has previously been saved, it will retrieve
	 * related TasquessRelatedByQuifa from storage. If this Usuaris is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getTasquessRelatedByQuifa($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsuarisPeer::DATABASE_NAME);
		}
		...
		if ($this->collTasquessRelatedByQuifa === null) {
			if ($this->isNew()) {
			   $this->collTasquessRelatedByQuifa = array();
				...
				$criteria->add(TasquesPeer::QUIFA, $this->usuariid);

				TasquesPeer::addSelectColumns($criteria);
				$this->collTasquessRelatedByQuifa = TasquesPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				TasquesPeer::addSelectColumns($criteria);
				if (!isset($this->lastTasquesRelatedByQuifaCriteria) || !$this->lastTasquesRelatedByQuifaCriteria->equals($criteria)) {
					$this->collTasquessRelatedByQuifa = TasquesPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTasquesRelatedByQuifaCriteria = $criteria;
		return $this->collTasquessRelatedByQuifa;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countTasquessRelatedByQuifa(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsuarisPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collTasquessRelatedByQuifa === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastTasquesRelatedByQuifaCriteria) || !$this->lastTasquesRelatedByQuifaCriteria->equals($criteria)) {
					...
					$count = count($this->collTasquessRelatedByQuifa);
				}
			} else {
				$count = count($this->collTasquessRelatedByQuifa);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addTasquesRelatedByQuifa(Tasques $l)
	{
		if ($this->collTasquessRelatedByQuifa === null) {
			$this->initTasquessRelatedByQuifa();
		}
		if (!in_array($l, $this->collTasquessRelatedByQuifa, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTasquessRelatedByQuifa, $l);
			$l->setUsuarisRelatedByQuifa($this);
		}
	}
	 ...
	 * Otherwise if this Usuaris is new, it will return
	 * an empty collection; or if this Usuaris has previously
	 * been saved, it will retrieve related TasquessRelatedByQuifa from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Usuaris.
	 */
	public function getTasquessRelatedByQuifaJoinActivitats($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsuarisPeer::DATABASE_NAME);
		}
		...
		if ($this->collTasquessRelatedByQuifa === null) {
			if ($this->isNew()) {
				...
				$this->collTasquessRelatedByQuifa = TasquesPeer::doSelectJoinActivitats($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collTasquessRelatedByQuimana) {
				foreach ((array) $this->collTasquessRelatedByQuimana as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collTasquessRelatedByQuifa) {
				foreach ((array) $this->collTasquessRelatedByQuifa as $o) {
					$o->clearAllReferences($deep);
				}
			}
