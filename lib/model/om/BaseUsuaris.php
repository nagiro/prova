...
abstract class BaseUsuaris extends BaseObject  implements Persistent {
	...
	public function setDataNaixement($v)
	{
		...
		if ( $this->data_naixement !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UsuarisPeer::DATA_NAIXEMENT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->data_naixement = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->resetModified();
			...
			return $startcol + 21; // 21 = UsuarisPeer::NUM_COLUMNS - UsuarisPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[20], $arr)) $this->setDataNaixement($arr[$keys[20]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsuarisPeer::DATA_NAIXEMENT)) $criteria->add(UsuarisPeer::DATA_NAIXEMENT, $this->data_naixement);
	...
	public function countTasquessRelatedByQuimana(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collTasquessRelatedByQuimana === null) {
			if ($this->isNew()) {
				...
				$count = TasquesPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	 ...
	 * actually need in Usuaris.
	 */
	public function getUsuarisMenussJoinSites($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsuarisPeer::DATABASE_NAME);
		}
		...
		if ($this->collUsuarisMenuss === null) {
			if ($this->isNew()) {
				...
				$this->collUsuarisMenuss = UsuarisMenusPeer::doSelectJoinSites($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
