...
abstract class BaseLog extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the dadesbefore field.
	 * @var        string
	 */
	protected $dadesbefore;

	/**
	 * The value for the dadesafter field.
	 * @var        string
	 */
	protected $dadesafter;
	...
	/**
	 * Get the [dadesbefore] column value.
	 * 
	 * @return     string
	 */
	public function getDadesbefore()
	{
		return $this->dadesbefore;
	}

	/**
	 * Get the [dadesafter] column value.
	 * 
	 * @return     string
	 */
	public function getDadesafter()
	{
		return $this->dadesafter;
	}
	...
	public function setUsuariid($v)
	{
		...
		if ($this->usuariid !== $v) {
			$this->usuariid = $v;
			$this->modifiedColumns[] = LogPeer::USUARIID;
		}
	...
	public function setAccio($v)
	{
		...
		if ($this->accio !== $v) {
			$this->accio = $v;
			$this->modifiedColumns[] = LogPeer::ACCIO;
		}
	...
	public function setModel($v)
	{
		...
		if ($this->model !== $v) {
			$this->model = $v;
			$this->modifiedColumns[] = LogPeer::MODEL;
		}
	...
	/**
	 * Set the value of [dadesbefore] column.
	 * 
	 * @param      string $v new value
	 * @return     Log The current object (for fluent API support)
	 */
	public function setDadesbefore($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->dadesbefore !== $v) {
			$this->dadesbefore = $v;
			$this->modifiedColumns[] = LogPeer::DADESBEFORE;
		}
	...
	/**
	 * Set the value of [dadesafter] column.
	 * 
	 * @param      string $v new value
	 * @return     Log The current object (for fluent API support)
	 */
	public function setDadesafter($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->dadesafter !== $v) {
			$this->dadesafter = $v;
			$this->modifiedColumns[] = LogPeer::DADESAFTER;
		}
	...
	public function setData($v)
	{
		...
		if ( $this->data !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = LogPeer::DATA;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->usuariid = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->accio = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->model = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->dadesbefore = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->dadesafter = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUsuaris !== null && $this->usuariid !== $this->aUsuaris->getUsuariid()) {
			$this->aUsuaris = null;
		}
	} // ensureConsistency
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				return $this->getDadesbefore();
				break;
			case 5:
				return $this->getDadesafter();
				break;
			case 6:
				return $this->getData();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getDadesbefore(),
			$keys[5] => $this->getDadesafter(),
			$keys[6] => $this->getData(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				$this->setDadesbefore($value);
				break;
			case 5:
				$this->setDadesafter($value);
				break;
			case 6:
				$this->setData($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setDadesbefore($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setDadesafter($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LogPeer::USUARIID)) $criteria->add(LogPeer::USUARIID, $this->usuariid);
		if ($this->isColumnModified(LogPeer::ACCIO)) $criteria->add(LogPeer::ACCIO, $this->accio);
		if ($this->isColumnModified(LogPeer::MODEL)) $criteria->add(LogPeer::MODEL, $this->model);
		if ($this->isColumnModified(LogPeer::DADESBEFORE)) $criteria->add(LogPeer::DADESBEFORE, $this->dadesbefore);
		if ($this->isColumnModified(LogPeer::DADESAFTER)) $criteria->add(LogPeer::DADESAFTER, $this->dadesafter);
		if ($this->isColumnModified(LogPeer::DATA)) $criteria->add(LogPeer::DATA, $this->data);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setUsuariid($this->usuariid);

		$copyObj->setAccio($this->accio);

		$copyObj->setModel($this->model);

		$copyObj->setDadesbefore($this->dadesbefore);

		$copyObj->setDadesafter($this->dadesafter);
	...
	{
		if ($this->aUsuaris === null && ($this->usuariid !== null)) {
			$this->aUsuaris = UsuarisPeer::retrieveByPk($this->usuariid);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuaris->addLogs($this);
			 */
		}
