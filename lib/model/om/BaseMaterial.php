...
abstract class BaseMaterial extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the identificador_comptable field.
	 * @var        string
	 */
	protected $identificador_comptable;
	...
	/**
	 * The value for the proveidor field.
	 * @var        string
	 */
	protected $proveidor;
	...
	/**
	 * The value for the amortitzacio field.
	 * @var        double
	 */
	protected $amortitzacio;

	/**
	 * The value for the vida_util field.
	 * @var        int
	 */
	protected $vida_util;
	...
	/**
	 * Get the [identificador_comptable] column value.
	 * 
	 * @return     string
	 */
	public function getIdentificadorComptable()
	{
		return $this->identificador_comptable;
	}
	...
	/**
	 * Get the [proveidor] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [amortitzacio] column value.
	 * 
	 * @return     double
	 */
	public function getAmortitzacio()
	{
		return $this->amortitzacio;
	}

	/**
	 * Get the [vida_util] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [identificador_comptable] column.
	 * 
	 * @param      string $v new value
	 * @return     Material The current object (for fluent API support)
	 */
	public function setIdentificadorComptable($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->identificador_comptable !== $v) {
			$this->identificador_comptable = $v;
			$this->modifiedColumns[] = MaterialPeer::IDENTIFICADOR_COMPTABLE;
		}

		return $this;
	} // setIdentificadorComptable()
	...
	/**
	 * Set the value of [proveidor] column.
	 * 
	 * @param      string $v new value
	 * @return     Material The current object (for fluent API support)
	 */
	public function setProveidor($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->proveidor !== $v) {
			$this->proveidor = $v;
			$this->modifiedColumns[] = MaterialPeer::PROVEIDOR;
		}
	...
	/**
	 * Set the value of [amortitzacio] column.
	 * 
	 * @param      double $v new value
	 * @return     Material The current object (for fluent API support)
	 */
	public function setAmortitzacio($v)
	{
		if ($v !== null) {
			$v = (double) $v;
		}

		if ($this->amortitzacio !== $v) {
			$this->amortitzacio = $v;
			$this->modifiedColumns[] = MaterialPeer::AMORTITZACIO;
		}
	...
	/**
	 * Set the value of [vida_util] column.
	 * 
	 * @param      int $v new value
	 * @return     Material The current object (for fluent API support)
	 */
	public function setVidaUtil($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->vida_util !== $v) {
			$this->vida_util = $v;
			$this->modifiedColumns[] = MaterialPeer::VIDA_UTIL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->identificador_comptable = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->numserie = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->datagarantia = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->datarevisio = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->cedit = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->datacessio = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->dataretorn = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->numfactura = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->proveidor = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->preu = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
			$this->amortitzacio = ($row[$startcol + 18] !== null) ? (double) $row[$startcol + 18] : null;
			$this->vida_util = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->notesmanteniment = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->databaixa = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->datareparacio = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->disponible = ($row[$startcol + 23] !== null) ? (int) $row[$startcol + 23] : null;
			$this->altaregistre = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
			$this->istransferible = ($row[$startcol + 25] !== null) ? (int) $row[$startcol + 25] : null;
			$this->isadministratiu = ($row[$startcol + 26] !== null) ? (int) $row[$startcol + 26] : null;
			$this->site_id = ($row[$startcol + 27] !== null) ? (int) $row[$startcol + 27] : null;
			$this->actiu = ($row[$startcol + 28] !== null) ? (int) $row[$startcol + 28] : null;
			$this->unitats = ($row[$startcol + 29] !== null) ? (int) $row[$startcol + 29] : null;
			$this->resetModified();
			...
			return $startcol + 30; // 30 = MaterialPeer::NUM_COLUMNS - MaterialPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 7:
				...
				break;
			case 8:
				return $this->getIdentificadorComptable();
				break;
			case 9:
			...
			case 15:
				...
				break;
			case 16:
				return $this->getProveidor();
				break;
			case 17:
				return $this->getPreu();
				break;
			case 18:
				return $this->getAmortitzacio();
				break;
			case 19:
				return $this->getVidaUtil();
				break;
			case 20:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[8] => $this->getIdentificadorComptable(),
			$keys[9] => $this->getNumserie(),
			$keys[10] => $this->getDatagarantia(),
			$keys[11] => $this->getDatarevisio(),
			$keys[12] => $this->getCedit(),
			$keys[13] => $this->getDatacessio(),
			$keys[14] => $this->getDataretorn(),
			$keys[15] => $this->getNumfactura(),
			$keys[16] => $this->getProveidor(),
			$keys[17] => $this->getPreu(),
			$keys[18] => $this->getAmortitzacio(),
			$keys[19] => $this->getVidaUtil(),
			$keys[20] => $this->getNotesmanteniment(),
			$keys[21] => $this->getDatabaixa(),
			$keys[22] => $this->getDatareparacio(),
			$keys[23] => $this->getDisponible(),
			$keys[24] => $this->getAltaregistre(),
			$keys[25] => $this->getIstransferible(),
			$keys[26] => $this->getIsadministratiu(),
			$keys[27] => $this->getSiteId(),
			$keys[28] => $this->getActiu(),
			$keys[29] => $this->getUnitats(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 7:
				...
				break;
			case 8:
				$this->setIdentificadorComptable($value);
				break;
			case 9:
			...
			case 15:
				...
				break;
			case 16:
				$this->setProveidor($value);
				break;
			case 17:
				$this->setPreu($value);
				break;
			case 18:
				$this->setAmortitzacio($value);
				break;
			case 19:
				$this->setVidaUtil($value);
				break;
			case 20:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setIdentificadorComptable($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setNumserie($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setDatagarantia($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setDatarevisio($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setCedit($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setDatacessio($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setDataretorn($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setNumfactura($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setProveidor($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setPreu($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setAmortitzacio($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setVidaUtil($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setNotesmanteniment($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setDatabaixa($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setDatareparacio($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setDisponible($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setAltaregistre($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setIstransferible($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setIsadministratiu($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setSiteId($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setActiu($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setUnitats($arr[$keys[29]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MaterialPeer::IDENTIFICADOR_COMPTABLE)) $criteria->add(MaterialPeer::IDENTIFICADOR_COMPTABLE, $this->identificador_comptable);
		...
		if ($this->isColumnModified(MaterialPeer::PROVEIDOR)) $criteria->add(MaterialPeer::PROVEIDOR, $this->proveidor);
		if ($this->isColumnModified(MaterialPeer::PREU)) $criteria->add(MaterialPeer::PREU, $this->preu);
		if ($this->isColumnModified(MaterialPeer::AMORTITZACIO)) $criteria->add(MaterialPeer::AMORTITZACIO, $this->amortitzacio);
		if ($this->isColumnModified(MaterialPeer::VIDA_UTIL)) $criteria->add(MaterialPeer::VIDA_UTIL, $this->vida_util);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdentificadorComptable($this->identificador_comptable);
		...
		$copyObj->setProveidor($this->proveidor);

		$copyObj->setPreu($this->preu);

		$copyObj->setAmortitzacio($this->amortitzacio);

		$copyObj->setVidaUtil($this->vida_util);
