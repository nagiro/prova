...
abstract class BaseMaterial extends BaseObject  implements Persistent {
  ...
  const PEER = 'MaterialPeer';
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(MaterialPeer::DISPONIBLE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->preu = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
			...
			return $startcol + 23; // 23 = MaterialPeer::NUM_COLUMNS - MaterialPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getMaterialgeneric(PropelPDO $con = null)
	{
		if ($this->aMaterialgeneric === null && ($this->materialgeneric_idmaterialgeneric !== null)) {
			$c = new Criteria(MaterialgenericPeer::DATABASE_NAME);
			$c->add(MaterialgenericPeer::IDMATERIALGENERIC, $this->materialgeneric_idmaterialgeneric);
			$this->aMaterialgeneric = MaterialgenericPeer::doSelectOne($c, $con);
	...
	public function countHorarisespaiss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collHorarisespaiss === null) {
			if ($this->isNew()) {
				...
				$count = HorarisespaisPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
