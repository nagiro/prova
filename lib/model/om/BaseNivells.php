...
abstract class BaseNivells extends BaseObject  implements Persistent {
	...
	public function setSiteId($v)
	{
		...
		if ($this->site_id !== $v || $this->isNew()) {
			$this->site_id = $v;
			$this->modifiedColumns[] = NivellsPeer::SITE_ID;
		}
	...
	public function setActiu($v)
	{
		...
		if ($this->actiu !== $v || $this->isNew()) {
			$this->actiu = $v;
			$this->modifiedColumns[] = NivellsPeer::ACTIU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = NivellsPeer::NUM_COLUMNS - NivellsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NivellsPeer::SITE_ID)) $criteria->add(NivellsPeer::SITE_ID, $this->site_id);
		if ($this->isColumnModified(NivellsPeer::ACTIU)) $criteria->add(NivellsPeer::ACTIU, $this->actiu);
	 ...
	 * related AppDocumentsPermisoss from storage. If this Nivells is new, it will return
		...
		if ($this->collAppDocumentsPermisoss === null) {
			if ($this->isNew()) {
			   $this->collAppDocumentsPermisoss = array();
				...
				$criteria->add(AppDocumentsPermisosPeer::IDNIVELL, $this->idnivells);
	 ...
	 */
	public function getAppDocumentsPermisossJoinUsuaris($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(NivellsPeer::DATABASE_NAME);
		}
		...
		if ($this->collAppDocumentsPermisoss === null) {
			if ($this->isNew()) {
				...
				$this->collAppDocumentsPermisoss = AppDocumentsPermisosPeer::doSelectJoinUsuaris($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Nivells has previously been saved, it will retrieve
	 * related AppDocumentsPermisosDirs from storage. If this Nivells is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Nivells has previously been saved, it will retrieve
	 * related UsuarisAppss from storage. If this Nivells is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Nivells has previously been saved, it will retrieve
	 * related UsuarisMenuss from storage. If this Nivells is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collUsuarisMenuss === null) {
			if ($this->isNew()) {
			   $this->collUsuarisMenuss = array();
				...
				$criteria->add(UsuarisMenusPeer::NIVELL_ID, $this->idnivells);
	 ...
	 * actually need in Nivells.
	 */
	public function getUsuarisMenussJoinUsuaris($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(NivellsPeer::DATABASE_NAME);
		}
		...
		if ($this->collUsuarisMenuss === null) {
			if ($this->isNew()) {
				...
				$this->collUsuarisMenuss = UsuarisMenusPeer::doSelectJoinUsuaris($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Nivells has previously been saved, it will retrieve
	 * related UsuarisSitess from storage. If this Nivells is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collUsuarisSitess === null) {
			if ($this->isNew()) {
			   $this->collUsuarisSitess = array();
				...
				$criteria->add(UsuarisSitesPeer::NIVELL_ID, $this->idnivells);
