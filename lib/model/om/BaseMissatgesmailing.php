...
abstract class BaseMissatgesmailing extends BaseObject  implements Persistent {
	...
	public function setSiteId($v)
	{
		...
		if ($this->site_id !== $v) {
			$this->site_id = $v;
			$this->modifiedColumns[] = MissatgesmailingPeer::SITE_ID;
		}
	...
	public function setActiu($v)
	{
		...
		if ($this->actiu !== $v) {
			$this->actiu = $v;
			$this->modifiedColumns[] = MissatgesmailingPeer::ACTIU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = MissatgesmailingPeer::NUM_COLUMNS - MissatgesmailingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MissatgesmailingPeer::SITE_ID)) $criteria->add(MissatgesmailingPeer::SITE_ID, $this->site_id);
		if ($this->isColumnModified(MissatgesmailingPeer::ACTIU)) $criteria->add(MissatgesmailingPeer::ACTIU, $this->actiu);
