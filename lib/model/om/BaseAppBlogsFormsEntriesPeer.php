...
abstract class BaseAppBlogsFormsEntriesPeer {
	...
	const SITE_ID = 'app_blogs_forms_entries.SITE_ID';

	/** the column name for the ACTIU field */
	const ACTIU = 'app_blogs_forms_entries.ACTIU';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Dades', 'Date', 'FormId', 'Estat', 'Objeccions', 'SiteId', 'Actiu', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'dades', 'date', 'formId', 'estat', 'objeccions', 'siteId', 'actiu', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DADES, self::DATE, self::FORM_ID, self::ESTAT, self::OBJECCIONS, self::SITE_ID, self::ACTIU, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'dades', 'date', 'form_id', 'estat', 'objeccions', 'site_id', 'actiu', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Dades' => 1, 'Date' => 2, 'FormId' => 3, 'Estat' => 4, 'Objeccions' => 5, 'SiteId' => 6, 'Actiu' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'dades' => 1, 'date' => 2, 'formId' => 3, 'estat' => 4, 'objeccions' => 5, 'siteId' => 6, 'actiu' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DADES => 1, self::DATE => 2, self::FORM_ID => 3, self::ESTAT => 4, self::OBJECCIONS => 5, self::SITE_ID => 6, self::ACTIU => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'dades' => 1, 'date' => 2, 'form_id' => 3, 'estat' => 4, 'objeccions' => 5, 'site_id' => 6, 'actiu' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AppBlogsFormsEntriesPeer::SITE_ID);
		$criteria->addSelectColumn(AppBlogsFormsEntriesPeer::ACTIU);
	}
