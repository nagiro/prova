...
abstract class BaseAppBlogsFormsEntriesPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Dades', 'Date', 'FormId', 'Estat', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'dades', 'date', 'formId', 'estat', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DADES, self::DATE, self::FORM_ID, self::ESTAT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'dades', 'date', 'form_id', 'estat', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Dades' => 1, 'Date' => 2, 'FormId' => 3, 'Estat' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'dades' => 1, 'date' => 2, 'formId' => 3, 'estat' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DADES => 1, self::DATE => 2, self::FORM_ID => 3, self::ESTAT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'dades' => 1, 'date' => 2, 'form_id' => 3, 'estat' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AppBlogsFormsEntriesMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsFormsEntriesPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsFormsEntriesPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsFormsEntriesPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsFormsEntriesPeer', $criteria, $con);
    }
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = AppBlogsFormsEntriesPeer::getOMClass();
	...
	public static function doCountJoinAppBlogsForms(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(AppBlogsFormsEntriesPeer::FORM_ID,), array(AppBlogsFormsPeer::ID,), $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAppBlogsForms(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{

    foreach (sfMixer::getCallables('BaseAppBlogsFormsEntriesPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsFormsEntriesPeer', $c, $con);
    }
		...
		AppBlogsFormsEntriesPeer::addSelectColumns($c);
		...
		$c->addJoin(array(AppBlogsFormsEntriesPeer::FORM_ID,), array(AppBlogsFormsPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = AppBlogsFormsEntriesPeer::getInstanceFromPool($key1))) {
				...
				$omClass = AppBlogsFormsEntriesPeer::getOMClass();
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsFormsEntriesPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsFormsEntriesPeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return AppBlogsFormsEntriesPeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsFormsEntriesPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseAppBlogsFormsEntriesPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsFormsEntriesPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsFormsEntriesPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsFormsEntriesPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseAppBlogsFormsEntriesPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsFormsEntriesPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsFormsEntriesPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof AppBlogsFormsEntries) {
	...
	public static function doValidate(AppBlogsFormsEntries $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(AppBlogsFormsEntriesPeer::DATABASE_NAME, AppBlogsFormsEntriesPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = AppBlogsFormsEntriesPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the AppBlogsFormsEntriesPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AppBlogsFormsEntriesPeer class:
//
// Propel::getDatabaseMap(AppBlogsFormsEntriesPeer::DATABASE_NAME)->addTableBuilder(AppBlogsFormsEntriesPeer::TABLE_NAME, AppBlogsFormsEntriesPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAppBlogsFormsEntriesPeer::DATABASE_NAME)->addTableBuilder(BaseAppBlogsFormsEntriesPeer::TABLE_NAME, BaseAppBlogsFormsEntriesPeer::getMapBuilder());
