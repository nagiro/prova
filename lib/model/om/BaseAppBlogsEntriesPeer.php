...
abstract class BaseAppBlogsEntriesPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PageId', 'Lang', 'Title', 'Body', 'Date', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'pageId', 'lang', 'title', 'body', 'date', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PAGE_ID, self::LANG, self::TITLE, self::BODY, self::DATE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'page_id', 'lang', 'title', 'body', 'date', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PageId' => 1, 'Lang' => 2, 'Title' => 3, 'Body' => 4, 'Date' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'pageId' => 1, 'lang' => 2, 'title' => 3, 'body' => 4, 'date' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PAGE_ID => 1, self::LANG => 2, self::TITLE => 3, self::BODY => 4, self::DATE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'page_id' => 1, 'lang' => 2, 'title' => 3, 'body' => 4, 'date' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
