...
abstract class BaseConceptes extends BaseObject  implements Persistent {
	...
	public function setSiteId($v)
	{
		...
		if ($this->site_id !== $v || $this->isNew()) {
			$this->site_id = $v;
			$this->modifiedColumns[] = ConceptesPeer::SITE_ID;
		}
	...
	public function setActiu($v)
	{
		...
		if ($this->actiu !== $v || $this->isNew()) {
			$this->actiu = $v;
			$this->modifiedColumns[] = ConceptesPeer::ACTIU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = ConceptesPeer::NUM_COLUMNS - ConceptesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConceptesPeer::SITE_ID)) $criteria->add(ConceptesPeer::SITE_ID, $this->site_id);
		if ($this->isColumnModified(ConceptesPeer::ACTIU)) $criteria->add(ConceptesPeer::ACTIU, $this->actiu);
