...
abstract class BaseMultimedia extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the id_extern field.
	 * @var        int
	 */
	protected $id_extern;
	...
	/**
	 * Get the [id_extern] column value.
	 * 
	 * @return     int
	 */
	...
	public function setMultimediaId($v)
	{
		...
		if ($this->multimedia_id !== $v) {
			...
			$this->modifiedColumns[] = MultimediaPeer::MULTIMEDIA_ID;
		}
	...
	public function setTaula($v)
	{
		...
		if ($this->taula !== $v) {
			$this->taula = $v;
			$this->modifiedColumns[] = MultimediaPeer::TAULA;
		}
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = MultimediaPeer::URL;
		}
	...
	public function setSiteId($v)
	{
		...
		if ($this->site_id !== $v) {
			$this->site_id = $v;
			$this->modifiedColumns[] = MultimediaPeer::SITE_ID;
		}
	...
	public function setActiu($v)
	{
		...
		if ($this->actiu !== $v) {
			$this->actiu = $v;
			$this->modifiedColumns[] = MultimediaPeer::ACTIU;
		}
	...
	/**
	 * Set the value of [id_extern] column.
	 * 
	 * @param      int $v new value
	 * @return     Multimedia The current object (for fluent API support)
	 */
	public function setIdExtern($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->id_extern !== $v) {
			$this->id_extern = $v;
			$this->modifiedColumns[] = MultimediaPeer::ID_EXTERN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->multimedia_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			$this->id_extern = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = MultimediaPeer::NUM_COLUMNS - MultimediaPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setMultimediaId($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setIdExtern($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MultimediaPeer::MULTIMEDIA_ID)) $criteria->add(MultimediaPeer::MULTIMEDIA_ID, $this->multimedia_id);
		if ($this->isColumnModified(MultimediaPeer::TAULA)) $criteria->add(MultimediaPeer::TAULA, $this->taula);
		if ($this->isColumnModified(MultimediaPeer::URL)) $criteria->add(MultimediaPeer::URL, $this->url);
		if ($this->isColumnModified(MultimediaPeer::SITE_ID)) $criteria->add(MultimediaPeer::SITE_ID, $this->site_id);
		if ($this->isColumnModified(MultimediaPeer::ACTIU)) $criteria->add(MultimediaPeer::ACTIU, $this->actiu);
		if ($this->isColumnModified(MultimediaPeer::ID_EXTERN)) $criteria->add(MultimediaPeer::ID_EXTERN, $this->id_extern);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MultimediaPeer::MULTIMEDIA_ID, $this->multimedia_id);
	...
	/**
	 * Generic method to set the primary key (multimedia_id column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdExtern($this->id_extern);


		$copyObj->setNew(true);

		$copyObj->setMultimediaId(NULL); // this is a auto-increment column, so set to default value
