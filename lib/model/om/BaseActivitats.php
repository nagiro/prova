...
abstract class BaseActivitats extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the isimportant field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	...
	/**
	 * Get the [isimportant] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [isimportant] column.
	 * 
	 * @param      int $v new value
	 * @return     Activitats The current object (for fluent API support)
	 */
	public function setIsimportant($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->isimportant !== $v || $this->isNew()) {
			$this->isimportant = $v;
			$this->modifiedColumns[] = ActivitatsPeer::ISIMPORTANT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->isimportant = ($row[$startcol + 27] !== null) ? (int) $row[$startcol + 27] : null;
			$this->resetModified();
			...
			return $startcol + 28; // 28 = ActivitatsPeer::NUM_COLUMNS - ActivitatsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[27], $arr)) $this->setIsimportant($arr[$keys[27]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActivitatsPeer::ISIMPORTANT)) $criteria->add(ActivitatsPeer::ISIMPORTANT, $this->isimportant);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsimportant($this->isimportant);
