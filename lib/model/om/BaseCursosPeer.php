  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			CursosPeer::doOnDeleteSetNull(new Criteria(CursosPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			CursosPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria = new Criteria(CursosPeer::DATABASE_NAME);
			$updateValues = new Criteria(CursosPeer::DATABASE_NAME);
			$selectCriteria->add(MatriculesPeer::CURSOS_IDCURSOS, $obj->getIdcursos());
			$updateValues->add(MatriculesPeer::CURSOS_IDCURSOS, null);
