  ...
  const PEER = 'CessiomaterialPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = CessiomaterialPeer::NUM_COLUMNS - CessiomaterialPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getCessio(PropelPDO $con = null)
	{
		if ($this->aCessio === null && ($this->cessio_id !== null)) {
			...
			$c->add(CessioPeer::CESSIO_ID, $this->cessio_id);
			$this->aCessio = CessioPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
