...
abstract class BaseNoticiesPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new NoticiesMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseNoticiesPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseNoticiesPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseNoticiesPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseNoticiesPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return NoticiesPeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseNoticiesPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseNoticiesPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseNoticiesPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseNoticiesPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseNoticiesPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseNoticiesPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseNoticiesPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseNoticiesPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Noticies) {
	...
	public static function doValidate(Noticies $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(NoticiesPeer::DATABASE_NAME, NoticiesPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = NoticiesPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the NoticiesPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the NoticiesPeer class:
//
// Propel::getDatabaseMap(NoticiesPeer::DATABASE_NAME)->addTableBuilder(NoticiesPeer::TABLE_NAME, NoticiesPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseNoticiesPeer::DATABASE_NAME)->addTableBuilder(BaseNoticiesPeer::TABLE_NAME, BaseNoticiesPeer::getMapBuilder());
