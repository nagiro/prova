  ...
  const PEER = 'AppBlogMultimediaEntriesPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = AppBlogMultimediaEntriesPeer::NUM_COLUMNS - AppBlogMultimediaEntriesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getAppBlogsEntries(PropelPDO $con = null)
	{
		if ($this->aAppBlogsEntries === null && ($this->entries_id !== null)) {
			...
			$c->add(AppBlogsEntriesPeer::ID, $this->entries_id);
			$this->aAppBlogsEntries = AppBlogsEntriesPeer::doSelectOne($c, $con);
	...
	public function getAppBlogsMultimedia(PropelPDO $con = null)
	{
		if ($this->aAppBlogsMultimedia === null && ($this->multimedia_id !== null)) {
			$c = new Criteria(AppBlogsMultimediaPeer::DATABASE_NAME);
			$c->add(AppBlogsMultimediaPeer::ID, $this->multimedia_id);
			$this->aAppBlogsMultimedia = AppBlogsMultimediaPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
