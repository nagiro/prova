  ...
  const PEER = 'MissatgesPeer';
	...
	public function setAltaregistre($v)
	{
		...
		if ( $this->altaregistre !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = MissatgesPeer::ALTAREGISTRE;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->altaregistre = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = MissatgesPeer::NUM_COLUMNS - MissatgesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setAltaregistre($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MissatgesPeer::ALTAREGISTRE)) $criteria->add(MissatgesPeer::ALTAREGISTRE, $this->altaregistre);
