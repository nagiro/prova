...
abstract class BaseEntradesReservaPeer {
	...
	/** the column name for the ENTRADES_RESERVA_ID field */
	const ENTRADES_RESERVA_ID = 'entrades_reserva.ENTRADES_RESERVA_ID';

	/** the column name for the USUARI_ID field */
	const USUARI_ID = 'entrades_reserva.USUARI_ID';

	/** the column name for the ACTIVITATS_ID field */
	const ACTIVITATS_ID = 'entrades_reserva.ACTIVITATS_ID';

	/** the column name for the QUANTES field */
	const QUANTES = 'entrades_reserva.QUANTES';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('EntradesReservaId', 'UsuariId', 'ActivitatsId', 'Quantes', 'Data', 'Estat', 'Actiu', 'SiteId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('entradesReservaId', 'usuariId', 'activitatsId', 'quantes', 'data', 'estat', 'actiu', 'siteId', ),
		BasePeer::TYPE_COLNAME => array (self::ENTRADES_RESERVA_ID, self::USUARI_ID, self::ACTIVITATS_ID, self::QUANTES, self::DATA, self::ESTAT, self::ACTIU, self::SITE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('entrades_reserva_id', 'usuari_id', 'activitats_id', 'quantes', 'data', 'estat', 'actiu', 'site_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('EntradesReservaId' => 0, 'UsuariId' => 1, 'ActivitatsId' => 2, 'Quantes' => 3, 'Data' => 4, 'Estat' => 5, 'Actiu' => 6, 'SiteId' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('entradesReservaId' => 0, 'usuariId' => 1, 'activitatsId' => 2, 'quantes' => 3, 'data' => 4, 'estat' => 5, 'actiu' => 6, 'siteId' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ENTRADES_RESERVA_ID => 0, self::USUARI_ID => 1, self::ACTIVITATS_ID => 2, self::QUANTES => 3, self::DATA => 4, self::ESTAT => 5, self::ACTIU => 6, self::SITE_ID => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('entrades_reserva_id' => 0, 'usuari_id' => 1, 'activitats_id' => 2, 'quantes' => 3, 'data' => 4, 'estat' => 5, 'actiu' => 6, 'site_id' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	{
		$criteria->addSelectColumn(EntradesReservaPeer::ENTRADES_RESERVA_ID);
		$criteria->addSelectColumn(EntradesReservaPeer::USUARI_ID);
		$criteria->addSelectColumn(EntradesReservaPeer::ACTIVITATS_ID);
		$criteria->addSelectColumn(EntradesReservaPeer::QUANTES);
	...
	public static function addInstanceToPool(EntradesReserva $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getEntradesReservaId();
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof EntradesReserva) {
				$key = (string) $value->getEntradesReservaId();
    ...
    foreach (sfMixer::getCallables('BaseEntradesReservaPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseEntradesReservaPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(EntradesReservaPeer::ENTRADES_RESERVA_ID) && $criteria->keyContainsValue(EntradesReservaPeer::ENTRADES_RESERVA_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.EntradesReservaPeer::ENTRADES_RESERVA_ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseEntradesReservaPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseEntradesReservaPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(EntradesReservaPeer::ENTRADES_RESERVA_ID);
			$selectCriteria->add(EntradesReservaPeer::ENTRADES_RESERVA_ID, $criteria->remove(EntradesReservaPeer::ENTRADES_RESERVA_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(EntradesReservaPeer::ENTRADES_RESERVA_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(EntradesReservaPeer::ENTRADES_RESERVA_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(EntradesReservaPeer::DATABASE_NAME);
			$criteria->add(EntradesReservaPeer::ENTRADES_RESERVA_ID, $pks, Criteria::IN);
