...
abstract class BaseEntradesReservaPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('EntradesReservaId', 'UsuariId', 'HorarisId', 'Quantes', 'Data', 'Estat', 'Actiu', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('entradesReservaId', 'usuariId', 'horarisId', 'quantes', 'data', 'estat', 'actiu', ),
		BasePeer::TYPE_COLNAME => array (self::ENTRADES_RESERVA_ID, self::USUARI_ID, self::HORARIS_ID, self::QUANTES, self::DATA, self::ESTAT, self::ACTIU, ),
		BasePeer::TYPE_FIELDNAME => array ('entrades_reserva_id', 'usuari_id', 'horaris_id', 'quantes', 'data', 'estat', 'actiu', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('EntradesReservaId' => 0, 'UsuariId' => 1, 'HorarisId' => 2, 'Quantes' => 3, 'Data' => 4, 'Estat' => 5, 'Actiu' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('entradesReservaId' => 0, 'usuariId' => 1, 'horarisId' => 2, 'quantes' => 3, 'data' => 4, 'estat' => 5, 'actiu' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ENTRADES_RESERVA_ID => 0, self::USUARI_ID => 1, self::HORARIS_ID => 2, self::QUANTES => 3, self::DATA => 4, self::ESTAT => 5, self::ACTIU => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('entrades_reserva_id' => 0, 'usuari_id' => 1, 'horaris_id' => 2, 'quantes' => 3, 'data' => 4, 'estat' => 5, 'actiu' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
