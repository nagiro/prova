  ...
  const PEER = 'AppDocumentsPermisosPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = AppDocumentsPermisosPeer::NUM_COLUMNS - AppDocumentsPermisosPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getAppDocumentsArxius(PropelPDO $con = null)
	{
		if ($this->aAppDocumentsArxius === null && ($this->idarxiu !== null)) {
			$c = new Criteria(AppDocumentsArxiusPeer::DATABASE_NAME);
			$c->add(AppDocumentsArxiusPeer::IDDOCUMENT, $this->idarxiu);
			$this->aAppDocumentsArxius = AppDocumentsArxiusPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
