...
abstract class BaseAppDocumentsArxiusPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Iddocument', 'Iddirectori', 'Nom', 'Url', 'Datacreacio', 'SiteId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('iddocument', 'iddirectori', 'nom', 'url', 'datacreacio', 'siteId', ),
		BasePeer::TYPE_COLNAME => array (self::IDDOCUMENT, self::IDDIRECTORI, self::NOM, self::URL, self::DATACREACIO, self::SITE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('idDocument', 'idDirectori', 'Nom', 'url', 'DataCreacio', 'site_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Iddocument' => 0, 'Iddirectori' => 1, 'Nom' => 2, 'Url' => 3, 'Datacreacio' => 4, 'SiteId' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('iddocument' => 0, 'iddirectori' => 1, 'nom' => 2, 'url' => 3, 'datacreacio' => 4, 'siteId' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::IDDOCUMENT => 0, self::IDDIRECTORI => 1, self::NOM => 2, self::URL => 3, self::DATACREACIO => 4, self::SITE_ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('idDocument' => 0, 'idDirectori' => 1, 'Nom' => 2, 'url' => 3, 'DataCreacio' => 4, 'site_id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
