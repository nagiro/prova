...
abstract class BaseCursos extends BaseObject  implements Persistent {
  ...
  const PEER = 'CursosPeer';
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(CursosPeer::ISACTIU))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 15; // 15 = CursosPeer::NUM_COLUMNS - CursosPeer::NUM_LAZY_LOAD_COLUMNS).
