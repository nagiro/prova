...
abstract class BaseCursos extends BaseObject  implements Persistent {
	...
	public function setPagamentextern($v)
	{
		...
		if ($this->pagamentextern !== $v) {
			...
			$this->modifiedColumns[] = CursosPeer::PAGAMENTEXTERN;
		}
	...
	public function setPagamentintern($v)
	{
		...
		if ($this->pagamentintern !== $v) {
			...
			$this->modifiedColumns[] = CursosPeer::PAGAMENTINTERN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->horaris = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->categoria = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->ordresortida = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->dataaparicio = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->datadesaparicio = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->datainmatricula = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->datafimatricula = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->datainici = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->visibleweb = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
			$this->site_id = ($row[$startcol + 16] !== null) ? (int) $row[$startcol + 16] : null;
			$this->actiu = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			$this->activitat_id = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->pdf = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->adescomptes = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->pagamentextern = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->pagamentintern = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->resetModified();
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getPreu(),
			$keys[7] => $this->getHoraris(),
			$keys[8] => $this->getCategoria(),
			$keys[9] => $this->getOrdresortida(),
			$keys[10] => $this->getDataaparicio(),
			$keys[11] => $this->getDatadesaparicio(),
			$keys[12] => $this->getDatainmatricula(),
			$keys[13] => $this->getDatafimatricula(),
			$keys[14] => $this->getDatainici(),
			$keys[15] => $this->getVisibleweb(),
			$keys[16] => $this->getSiteId(),
			$keys[17] => $this->getActiu(),
			$keys[18] => $this->getActivitatId(),
			$keys[19] => $this->getPdf(),
			$keys[20] => $this->getAdescomptes(),
			$keys[21] => $this->getPagamentextern(),
			$keys[22] => $this->getPagamentintern(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setHoraris($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setCategoria($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setOrdresortida($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setDataaparicio($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setDatadesaparicio($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setDatainmatricula($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setDatafimatricula($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setDatainici($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setVisibleweb($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setSiteId($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setActiu($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setActivitatId($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setPdf($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setAdescomptes($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setPagamentextern($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setPagamentintern($arr[$keys[22]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CursosPeer::PAGAMENTEXTERN)) $criteria->add(CursosPeer::PAGAMENTEXTERN, $this->pagamentextern);
		if ($this->isColumnModified(CursosPeer::PAGAMENTINTERN)) $criteria->add(CursosPeer::PAGAMENTINTERN, $this->pagamentintern);
