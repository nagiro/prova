...
abstract class BaseCursos extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->pagamentextern = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->pagamentintern = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[19] => $this->getPagamentextern(),
			$keys[20] => $this->getPagamentintern(),
			$keys[21] => $this->getPdf(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[19], $arr)) $this->setPagamentextern($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setPagamentintern($arr[$keys[20]]);
