...
abstract class BaseCursos extends BaseObject  implements Persistent {
	...
	public function setActiva($v)
	{
		...
		if ($this->activa !== $v || $this->isNew()) {
			$this->activa = $v;
			$this->modifiedColumns[] = CursosPeer::ACTIVA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->activa = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			$this->resetModified();
			...
			return $startcol + 18; // 18 = CursosPeer::NUM_COLUMNS - CursosPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[17], $arr)) $this->setActiva($arr[$keys[17]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CursosPeer::ACTIVA)) $criteria->add(CursosPeer::ACTIVA, $this->activa);
