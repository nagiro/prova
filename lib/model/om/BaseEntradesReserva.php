...
abstract class BaseEntradesReserva extends BaseObject  implements Persistent {
	...
	public function setIdentrada($v)
	{
		...
		if ($this->identrada !== $v || $this->isNew()) {
			$this->identrada = $v;
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = EntradesReservaPeer::NUM_COLUMNS - EntradesReservaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdentrada($this->identrada);
