...
abstract class BaseEntradesReserva extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the entrades_reserva_id field.
	 * @var        int
	 */
	protected $entrades_reserva_id;
	...
	/**
	 * The value for the activitats_id field.
	 * @var        int
	 */
	protected $activitats_id;

	/**
	 * The value for the quantes field.
	 * @var        int
	 */
	protected $quantes;
	...
	/**
	 * Get the [entrades_reserva_id] column value.
	 * 
	 * @return     int
	 */
	public function getEntradesReservaId()
	{
		return $this->entrades_reserva_id;
	}
	...
	/**
	 * Get the [activitats_id] column value.
	 * 
	 * @return     int
	 */
	public function getActivitatsId()
	{
		return $this->activitats_id;
	}

	/**
	 * Get the [quantes] column value.
	 * 
	 * @return     int
	 */
	public function getQuantes()
	{
		return $this->quantes;
	}
	...
	/**
	 * Set the value of [entrades_reserva_id] column.
	 * 
	 * @param      int $v new value
	 * @return     EntradesReserva The current object (for fluent API support)
	 */
	public function setEntradesReservaId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->entrades_reserva_id !== $v) {
			$this->entrades_reserva_id = $v;
			$this->modifiedColumns[] = EntradesReservaPeer::ENTRADES_RESERVA_ID;
		}

		return $this;
	} // setEntradesReservaId()
	...
	/**
	 * Set the value of [activitats_id] column.
	 * 
	 * @param      int $v new value
	 * @return     EntradesReserva The current object (for fluent API support)
	 */
	public function setActivitatsId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->activitats_id !== $v) {
			$this->activitats_id = $v;
			$this->modifiedColumns[] = EntradesReservaPeer::ACTIVITATS_ID;
		}
	...
	/**
	 * Set the value of [quantes] column.
	 * 
	 * @param      int $v new value
	 * @return     EntradesReserva The current object (for fluent API support)
	 */
	public function setQuantes($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->quantes !== $v) {
			$this->quantes = $v;
			$this->modifiedColumns[] = EntradesReservaPeer::QUANTES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->entrades_reserva_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->usuari_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->activitats_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->quantes = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 8; // 8 = EntradesReservaPeer::NUM_COLUMNS - EntradesReservaPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setEntradesReservaId($pk);  //[IMV] update autoincrement primary key
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				return $this->getEntradesReservaId();
				break;
			case 1:
				return $this->getUsuariId();
				break;
			case 2:
				return $this->getActivitatsId();
				break;
			case 3:
				return $this->getQuantes();
				break;
			case 4:
				return $this->getData();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getEntradesReservaId(),
			$keys[1] => $this->getUsuariId(),
			$keys[2] => $this->getActivitatsId(),
			$keys[3] => $this->getQuantes(),
			$keys[4] => $this->getData(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				$this->setEntradesReservaId($value);
				break;
			case 1:
				$this->setUsuariId($value);
				break;
			case 2:
				$this->setActivitatsId($value);
				break;
			case 3:
				$this->setQuantes($value);
				break;
			case 4:
				$this->setData($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setEntradesReservaId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setUsuariId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setActivitatsId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setQuantes($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EntradesReservaPeer::ENTRADES_RESERVA_ID)) $criteria->add(EntradesReservaPeer::ENTRADES_RESERVA_ID, $this->entrades_reserva_id);
		if ($this->isColumnModified(EntradesReservaPeer::USUARI_ID)) $criteria->add(EntradesReservaPeer::USUARI_ID, $this->usuari_id);
		if ($this->isColumnModified(EntradesReservaPeer::ACTIVITATS_ID)) $criteria->add(EntradesReservaPeer::ACTIVITATS_ID, $this->activitats_id);
		if ($this->isColumnModified(EntradesReservaPeer::QUANTES)) $criteria->add(EntradesReservaPeer::QUANTES, $this->quantes);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EntradesReservaPeer::ENTRADES_RESERVA_ID, $this->entrades_reserva_id);
	...
	/**
	 * Generic method to set the primary key (entrades_reserva_id column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setActivitatsId($this->activitats_id);

		$copyObj->setQuantes($this->quantes);
		...
		$copyObj->setEntradesReservaId(NULL); // this is a auto-increment column, so set to default value
