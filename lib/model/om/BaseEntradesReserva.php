...
abstract class BaseEntradesReserva extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the horaris_id field.
	 * @var        int
	 */
	protected $horaris_id;
	...
	/**
	 * Get the [horaris_id] column value.
	 * 
	 * @return     int
	 */
	public function getHorarisId()
	{
		return $this->horaris_id;
	}
	...
	/**
	 * Set the value of [horaris_id] column.
	 * 
	 * @param      int $v new value
	 * @return     EntradesReserva The current object (for fluent API support)
	 */
	public function setHorarisId($v)
	{
		...
		if ($this->horaris_id !== $v) {
			$this->horaris_id = $v;
			$this->modifiedColumns[] = EntradesReservaPeer::HORARIS_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->horaris_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setHorarisId($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EntradesReservaPeer::HORARIS_ID)) $criteria->add(EntradesReservaPeer::HORARIS_ID, $this->horaris_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setHorarisId($this->horaris_id);
