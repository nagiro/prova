...
abstract class BaseAppBlogsBlogsPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AppBlogsBlogsMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsBlogsPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsBlogsPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsBlogsPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsBlogsPeer', $criteria, $con);
    }
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = AppBlogsBlogsPeer::getOMClass();
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return AppBlogsBlogsPeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsBlogsPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseAppBlogsBlogsPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsBlogsPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsBlogsPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsBlogsPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseAppBlogsBlogsPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsBlogsPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsBlogsPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof AppBlogsBlogs) {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(AppBlogsFormsPeer::BLOG_ID, $obj->getId());
			$affectedRows += AppBlogsFormsPeer::doDelete($c, $con);

			// delete related AppBlogsMenu objects
			$c = new Criteria(AppBlogsMenuPeer::DATABASE_NAME);
			
			$c->add(AppBlogsMenuPeer::BLOG_ID, $obj->getId());
			...
			$c->add(AppBlogsPagesPeer::BLOG_ID, $obj->getId());
			$affectedRows += AppBlogsPagesPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function doValidate(AppBlogsBlogs $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(AppBlogsBlogsPeer::DATABASE_NAME, AppBlogsBlogsPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = AppBlogsBlogsPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the AppBlogsBlogsPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AppBlogsBlogsPeer class:
//
// Propel::getDatabaseMap(AppBlogsBlogsPeer::DATABASE_NAME)->addTableBuilder(AppBlogsBlogsPeer::TABLE_NAME, AppBlogsBlogsPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAppBlogsBlogsPeer::DATABASE_NAME)->addTableBuilder(BaseAppBlogsBlogsPeer::TABLE_NAME, BaseAppBlogsBlogsPeer::getMapBuilder());
