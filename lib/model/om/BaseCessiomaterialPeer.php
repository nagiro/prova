...
abstract class BaseCessiomaterialPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idcessiomaterial', 'MaterialIdmaterial', 'Cedita', 'Datacessio', 'Dataretorn', 'Estat', 'Retornat', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idcessiomaterial', 'materialIdmaterial', 'cedita', 'datacessio', 'dataretorn', 'estat', 'retornat', ),
		BasePeer::TYPE_COLNAME => array (self::IDCESSIOMATERIAL, self::MATERIAL_IDMATERIAL, self::CEDITA, self::DATACESSIO, self::DATARETORN, self::ESTAT, self::RETORNAT, ),
		BasePeer::TYPE_FIELDNAME => array ('idCessioMaterial', 'Material_idMaterial', 'Cedita', 'DataCessio', 'DataRetorn', 'Estat', 'Retornat', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idcessiomaterial' => 0, 'MaterialIdmaterial' => 1, 'Cedita' => 2, 'Datacessio' => 3, 'Dataretorn' => 4, 'Estat' => 5, 'Retornat' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idcessiomaterial' => 0, 'materialIdmaterial' => 1, 'cedita' => 2, 'datacessio' => 3, 'dataretorn' => 4, 'estat' => 5, 'retornat' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::IDCESSIOMATERIAL => 0, self::MATERIAL_IDMATERIAL => 1, self::CEDITA => 2, self::DATACESSIO => 3, self::DATARETORN => 4, self::ESTAT => 5, self::RETORNAT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('idCessioMaterial' => 0, 'Material_idMaterial' => 1, 'Cedita' => 2, 'DataCessio' => 3, 'DataRetorn' => 4, 'Estat' => 5, 'Retornat' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
