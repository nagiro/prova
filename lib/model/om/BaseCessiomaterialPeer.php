...
abstract class BaseCessiomaterialPeer {
	...
	public static function doCountJoinCessio(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CessiomaterialPeer::CESSIO_ID,), array(CessioPeer::CESSIO_ID,), $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinCessio(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(CessiomaterialPeer::CESSIO_ID,), array(CessioPeer::CESSIO_ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
    ...
    foreach (sfMixer::getCallables('BaseCessiomaterialPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseCessiomaterialPeer', $c, $con);
    }
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptCessio(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
