...
abstract class BaseCessiomaterialPeer {
	...
	const OM_CLASS = 'Cessiomaterial';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.Cessiomaterial';

	/** the related TableMap class for this table */
	const TM_CLASS = 'CessiomaterialTableMap';
	...
	const CESSIO_ID = 'cessiomaterial.CESSIO_ID';

	/** the column name for the SITE_ID field */
	const SITE_ID = 'cessiomaterial.SITE_ID';

	/** the column name for the ACTIU field */
	const ACTIU = 'cessiomaterial.ACTIU';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idcessiomaterial', 'MaterialIdmaterial', 'CessioId', 'SiteId', 'Actiu', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idcessiomaterial', 'materialIdmaterial', 'cessioId', 'siteId', 'actiu', ),
		BasePeer::TYPE_COLNAME => array (self::IDCESSIOMATERIAL, self::MATERIAL_IDMATERIAL, self::CESSIO_ID, self::SITE_ID, self::ACTIU, ),
		BasePeer::TYPE_FIELDNAME => array ('idCessioMaterial', 'Material_idMaterial', 'cessio_id', 'site_id', 'actiu', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idcessiomaterial' => 0, 'MaterialIdmaterial' => 1, 'CessioId' => 2, 'SiteId' => 3, 'Actiu' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idcessiomaterial' => 0, 'materialIdmaterial' => 1, 'cessioId' => 2, 'siteId' => 3, 'actiu' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::IDCESSIOMATERIAL => 0, self::MATERIAL_IDMATERIAL => 1, self::CESSIO_ID => 2, self::SITE_ID => 3, self::ACTIU => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('idCessioMaterial' => 0, 'Material_idMaterial' => 1, 'cessio_id' => 2, 'site_id' => 3, 'actiu' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CessiomaterialPeer::CESSIO_ID);
		$criteria->addSelectColumn(CessiomaterialPeer::SITE_ID);
		$criteria->addSelectColumn(CessiomaterialPeer::ACTIU);
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to cessiomaterial
	...
	public static function doCountJoinMaterial(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CessiomaterialPeer::MATERIAL_IDMATERIAL, MaterialPeer::IDMATERIAL, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Cessio table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinCessio(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Cessiomaterial objects pre-filled with their Cessio objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Cessiomaterial objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinCessio(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = CessioPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				...
				// Add the $obj1 (Cessiomaterial) to $obj2 (Cessio)
				$obj2->addCessiomaterial($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CessioPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (CessioPeer::NUM_COLUMNS - CessioPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key3 = CessioPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = CessioPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					CessioPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (Cessiomaterial) to the collection in $obj3 (Cessio)
				$obj3->addCessiomaterial($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptCessio(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Cessiomaterial objects pre-filled with all related objects except Cessio.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptCessio(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseCessiomaterialPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseCessiomaterialPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new CessiomaterialTableMap());
	  }
	}
	...
	{
		return $withPrefix ? CessiomaterialPeer::CLASS_DEFAULT : CessiomaterialPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCessiomaterialPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCessiomaterialPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCessiomaterialPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCessiomaterialPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCessiomaterialPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCessiomaterialPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCessiomaterialPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCessiomaterialPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			CessiomaterialPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Cessiomaterial) { // it's a model object
	...
	public static function doValidate(Cessiomaterial $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(CessiomaterialPeer::DATABASE_NAME, CessiomaterialPeer::TABLE_NAME, $columns);
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseCessiomaterialPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
...
//
BaseCessiomaterialPeer::buildTableMap();
