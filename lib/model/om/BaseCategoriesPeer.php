...
abstract class BaseCategoriesPeer {
	...
	/** the column name for the IDCATEGORIES field */
	const IDCATEGORIES = 'categories.IDCATEGORIES';

	/** the column name for the TIPUS field */
	const TIPUS = 'categories.TIPUS';

	/** the column name for the CATEGORIA field */
	const CATEGORIA = 'categories.CATEGORIA';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idcategories', 'Tipus', 'Categoria', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idcategories', 'tipus', 'categoria', ),
		BasePeer::TYPE_COLNAME => array (self::IDCATEGORIES, self::TIPUS, self::CATEGORIA, ),
		BasePeer::TYPE_FIELDNAME => array ('idCategories', 'Tipus', 'Categoria', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idcategories' => 0, 'Tipus' => 1, 'Categoria' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idcategories' => 0, 'tipus' => 1, 'categoria' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::IDCATEGORIES => 0, self::TIPUS => 1, self::CATEGORIA => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('idCategories' => 0, 'Tipus' => 1, 'Categoria' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new CategoriesMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoriesPeer::IDCATEGORIES);

		$criteria->addSelectColumn(CategoriesPeer::TIPUS);

		$criteria->addSelectColumn(CategoriesPeer::CATEGORIA);
    ...
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseCategoriesPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      Categories $value A Categories object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Categories $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getIdcategories();
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Categories) {
				$key = (string) $value->getIdcategories();
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Categories or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(CategoriesPeer::IDCATEGORIES) && $criteria->keyContainsValue(CategoriesPeer::IDCATEGORIES) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.CategoriesPeer::IDCATEGORIES.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Categories or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CategoriesPeer::IDCATEGORIES);
			$selectCriteria->add(CategoriesPeer::IDCATEGORIES, $criteria->remove(CategoriesPeer::IDCATEGORIES), $comparison);
	...
	/**
	 * Method to DELETE all rows from the categories table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += CategoriesPeer::doOnDeleteCascade(new Criteria(CategoriesPeer::DATABASE_NAME), $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Categories or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof Categories) {
			...
			$criteria->add(CategoriesPeer::IDCATEGORIES, (array) $values, Criteria::IN);
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += CategoriesPeer::doOnDeleteCascade($criteria, $con);
			...
			// invalidate objects in SubcategoriesPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = CategoriesPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related Subcategories objects
			$c = new Criteria(SubcategoriesPeer::DATABASE_NAME);
			
			$c->add(SubcategoriesPeer::CATEGORIES_IDCATEGORIES, $obj->getIdcategories());
			$affectedRows += SubcategoriesPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(CategoriesPeer::IDCATEGORIES, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(CategoriesPeer::DATABASE_NAME);
			$criteria->add(CategoriesPeer::IDCATEGORIES, $pks, Criteria::IN);
...
//
// NOTE: This static code cannot call methods on the CategoriesPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the CategoriesPeer class:
//
// Propel::getDatabaseMap(CategoriesPeer::DATABASE_NAME)->addTableBuilder(CategoriesPeer::TABLE_NAME, CategoriesPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseCategoriesPeer::DATABASE_NAME)->addTableBuilder(BaseCategoriesPeer::TABLE_NAME, BaseCategoriesPeer::getMapBuilder());
