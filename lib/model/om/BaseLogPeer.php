...
abstract class BaseLogPeer {
	...
	const USUARIID = 'log.USUARIID';

	/** the column name for the ACCIO field */
	const ACCIO = 'log.ACCIO';

	/** the column name for the MODEL field */
	const MODEL = 'log.MODEL';

	/** the column name for the DADESBEFORE field */
	const DADESBEFORE = 'log.DADESBEFORE';

	/** the column name for the DADESAFTER field */
	const DADESAFTER = 'log.DADESAFTER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Usuariid', 'Accio', 'Model', 'Dadesbefore', 'Dadesafter', 'Data', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'usuariid', 'accio', 'model', 'dadesbefore', 'dadesafter', 'data', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USUARIID, self::ACCIO, self::MODEL, self::DADESBEFORE, self::DADESAFTER, self::DATA, ),
		BasePeer::TYPE_FIELDNAME => array ('Id', 'UsuariID', 'Accio', 'Model', 'DadesBefore', 'DadesAfter', 'Data', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Usuariid' => 1, 'Accio' => 2, 'Model' => 3, 'Dadesbefore' => 4, 'Dadesafter' => 5, 'Data' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'usuariid' => 1, 'accio' => 2, 'model' => 3, 'dadesbefore' => 4, 'dadesafter' => 5, 'data' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USUARIID => 1, self::ACCIO => 2, self::MODEL => 3, self::DADESBEFORE => 4, self::DADESAFTER => 5, self::DATA => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('Id' => 0, 'UsuariID' => 1, 'Accio' => 2, 'Model' => 3, 'DadesBefore' => 4, 'DadesAfter' => 5, 'Data' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LogPeer::USUARIID);
		$criteria->addSelectColumn(LogPeer::ACCIO);
		$criteria->addSelectColumn(LogPeer::MODEL);
		$criteria->addSelectColumn(LogPeer::DADESBEFORE);
		$criteria->addSelectColumn(LogPeer::DADESAFTER);
		$criteria->addSelectColumn(LogPeer::DATA);
	}
	...
	public static function doCountJoinUsuaris(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LogPeer::USUARIID, UsuarisPeer::USUARIID, $join_behavior);
	...
	/**
	 * Selects a collection of Log objects pre-filled with their Usuaris objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinUsuaris(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to $obj2 (Usuaris)
				$obj2->addLog($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to the collection in $obj2 (Usuaris)
				$obj2->addLog($obj1);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLogPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseLogPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLogPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseLogPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLogPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseLogPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLogPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseLogPeer', $values, $con, $ret);
    }
