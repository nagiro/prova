...
abstract class BaseApps extends BaseObject  implements Persistent {
	...
	public function setSiteId($v)
	{
		...
		if ($this->site_id !== $v) {
			$this->site_id = $v;
			$this->modifiedColumns[] = AppsPeer::SITE_ID;
		}
	...
	public function setActiu($v)
	{
		...
		if ($this->actiu !== $v || $this->isNew()) {
			$this->actiu = $v;
			$this->modifiedColumns[] = AppsPeer::ACTIU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = AppsPeer::NUM_COLUMNS - AppsPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setAppId($pk);  //[IMV] update autoincrement primary key
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AppsPeer::SITE_ID)) $criteria->add(AppsPeer::SITE_ID, $this->site_id);
		if ($this->isColumnModified(AppsPeer::ACTIU)) $criteria->add(AppsPeer::ACTIU, $this->actiu);
