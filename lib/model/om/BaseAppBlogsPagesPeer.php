...
abstract class BaseAppBlogsPagesPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Visible', 'Date', 'Type', 'BlogId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'visible', 'date', 'type', 'blogId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::VISIBLE, self::DATE, self::TYPE, self::BLOG_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'visible', 'date', 'type', 'blog_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Visible' => 2, 'Date' => 3, 'Type' => 4, 'BlogId' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'visible' => 2, 'date' => 3, 'type' => 4, 'blogId' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::VISIBLE => 2, self::DATE => 3, self::TYPE => 4, self::BLOG_ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'visible' => 2, 'date' => 3, 'type' => 4, 'blog_id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AppBlogsPagesMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsPagesPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsPagesPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsPagesPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsPagesPeer', $criteria, $con);
    }
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = AppBlogsPagesPeer::getOMClass();
	...
	public static function doCountJoinAppBlogsBlogs(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(AppBlogsPagesPeer::BLOG_ID,), array(AppBlogsBlogsPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsPagesPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsPagesPeer', $c, $con);
    }
		...
		$c->addJoin(array(AppBlogsPagesPeer::BLOG_ID,), array(AppBlogsBlogsPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsPagesPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsPagesPeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return AppBlogsPagesPeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsPagesPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseAppBlogsPagesPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsPagesPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsPagesPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsPagesPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseAppBlogsPagesPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseAppBlogsPagesPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseAppBlogsPagesPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof AppBlogsPages) {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c = new Criteria(AppBlogsEntriesPeer::DATABASE_NAME);
			
			$c->add(AppBlogsEntriesPeer::PAGE_ID, $obj->getId());
			$affectedRows += AppBlogsEntriesPeer::doDelete($c, $con);

			// delete related AppBlogsMenu objects
			$c = new Criteria(AppBlogsMenuPeer::DATABASE_NAME);
			
			$c->add(AppBlogsMenuPeer::PAGE_ID, $obj->getId());
			$affectedRows += AppBlogsMenuPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function doValidate(AppBlogsPages $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(AppBlogsPagesPeer::DATABASE_NAME, AppBlogsPagesPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = AppBlogsPagesPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the AppBlogsPagesPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AppBlogsPagesPeer class:
//
// Propel::getDatabaseMap(AppBlogsPagesPeer::DATABASE_NAME)->addTableBuilder(AppBlogsPagesPeer::TABLE_NAME, AppBlogsPagesPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAppBlogsPagesPeer::DATABASE_NAME)->addTableBuilder(BaseAppBlogsPagesPeer::TABLE_NAME, BaseAppBlogsPagesPeer::getMapBuilder());
