...
class PoblacionsTableMap extends TableMap {
	...
	{
    $this->addRelation('EspaisExterns', 'EspaisExterns', RelationMap::ONE_TO_MANY, array('idPoblacio' => 'Poble', ), 'CASCADE', 'CASCADE');
    $this->addRelation('Usuaris', 'Usuaris', RelationMap::ONE_TO_MANY, array('idPoblacio' => 'Poblacio', ), 'SET NULL', 'SET NULL');
	} // buildRelations()
