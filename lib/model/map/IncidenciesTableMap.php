...
class IncidenciesTableMap extends TableMap {
	...
	{
    $this->addRelation('UsuarisRelatedByQuiinforma', 'Usuaris', RelationMap::MANY_TO_ONE, array('quiinforma' => 'UsuariID', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('UsuarisRelatedByQuiresol', 'Usuaris', RelationMap::MANY_TO_ONE, array('quiresol' => 'UsuariID', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
