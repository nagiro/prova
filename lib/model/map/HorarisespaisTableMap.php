...
class HorarisespaisTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('IDESPAIEXTERN', 'Idespaiextern', 'INTEGER', false, 11, null);
	...
	{
    $this->addRelation('Material', 'Material', RelationMap::MANY_TO_ONE, array('Material_idMaterial' => 'idMaterial', ), 'SET NULL', 'SET NULL');
    $this->addRelation('Espais', 'Espais', RelationMap::MANY_TO_ONE, array('Espais_EspaiID' => 'EspaiID', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('Horaris', 'Horaris', RelationMap::MANY_TO_ONE, array('Horaris_HorarisID' => 'HorarisID', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
