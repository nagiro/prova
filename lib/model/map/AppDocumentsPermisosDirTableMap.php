...
class AppDocumentsPermisosDirTableMap extends TableMap {
	...
	{
    $this->addRelation('Usuaris', 'Usuaris', RelationMap::MANY_TO_ONE, array('idUsuari' => 'UsuariID', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('AppDocumentsDirectoris', 'AppDocumentsDirectoris', RelationMap::MANY_TO_ONE, array('idDirectori' => 'idDirectori', ), 'RESTRICT', 'CASCADE');
