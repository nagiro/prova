...
class EspaisExternsTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('POBLE', 'Poble', 'INTEGER', 'poblacions', 'IDPOBLACIO', true, 11, null);
	...
	{
    $this->addRelation('Poblacions', 'Poblacions', RelationMap::MANY_TO_ONE, array('Poble' => 'idPoblacio', ), 'CASCADE', 'CASCADE');
    $this->addRelation('Horarisespais', 'Horarisespais', RelationMap::ONE_TO_MANY, array('idEspaiextern' => 'idEspaiextern', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
