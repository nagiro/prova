...
class UsuarisMenusTableMap extends TableMap {
	...
	{
    $this->addRelation('Usuaris', 'Usuaris', RelationMap::MANY_TO_ONE, array('usuari_id' => 'UsuariID', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('GestioMenus', 'GestioMenus', RelationMap::MANY_TO_ONE, array('menu_id' => 'menu_id', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('Sites', 'Sites', RelationMap::MANY_TO_ONE, array('site_id' => 'site_id', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('Nivells', 'Nivells', RelationMap::MANY_TO_ONE, array('nivell_id' => 'idNivells', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
