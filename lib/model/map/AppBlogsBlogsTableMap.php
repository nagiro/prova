...
class AppBlogsBlogsTableMap extends TableMap {
	...
	{
    $this->addRelation('AppBlogsForms', 'AppBlogsForms', RelationMap::ONE_TO_MANY, array('id' => 'blog_id', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('AppBlogsMenu', 'AppBlogsMenu', RelationMap::ONE_TO_MANY, array('id' => 'blog_id', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('AppBlogsPages', 'AppBlogsPages', RelationMap::ONE_TO_MANY, array('id' => 'blog_id', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
