...
class TasquesTableMap extends TableMap {
	...
	{
    $this->addRelation('Activitats', 'Activitats', RelationMap::MANY_TO_ONE, array('Activitats_ActivitatID' => 'ActivitatID', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('UsuarisRelatedByQuimana', 'Usuaris', RelationMap::MANY_TO_ONE, array('QuiMana' => 'UsuariID', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('UsuarisRelatedByQuifa', 'Usuaris', RelationMap::MANY_TO_ONE, array('QuiFa' => 'UsuariID', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
