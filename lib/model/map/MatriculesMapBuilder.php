...
class MatriculesMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('CURSOS_IDCURSOS', 'CursosIdcursos', 'INTEGER', 'cursos', 'IDCURSOS', true, 11);
		...
		$tMap->addColumn('DESCOMPTE', 'Descompte', 'DOUBLE', false, null);

		$tMap->addColumn('TREDUCCIO', 'Treduccio', 'CHAR', true, 1);

		$tMap->addColumn('TPAGAMENT', 'Tpagament', 'CHAR', true, 1);
