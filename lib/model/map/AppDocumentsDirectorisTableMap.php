...
class AppDocumentsDirectorisTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('PARE', 'Pare', 'INTEGER', 'app_documents_directoris', 'IDDIRECTORI', false, 11, null);
		// validators
	} // initialize()
	...
	{
    $this->addRelation('AppDocumentsDirectorisRelatedByPare', 'AppDocumentsDirectoris', RelationMap::MANY_TO_ONE, array('Pare' => 'idDirectori', ), 'SET NULL', 'SET NULL');
    ...
    $this->addRelation('AppDocumentsDirectorisRelatedByPare', 'AppDocumentsDirectoris', RelationMap::ONE_TO_MANY, array('idDirectori' => 'Pare', ), 'SET NULL', 'SET NULL');
