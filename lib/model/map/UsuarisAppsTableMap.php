...
class UsuarisAppsTableMap extends TableMap {
    ...
    $this->addRelation('Apps', 'Apps', RelationMap::MANY_TO_ONE, array('app_id' => 'app_id', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('Nivells', 'Nivells', RelationMap::MANY_TO_ONE, array('nivell_id' => 'idNivells', ), 'RESTRICT', 'SET NULL');
	} // buildRelations()
