...
class CessiomaterialTableMap extends TableMap {
	...
	{
    $this->addRelation('Material', 'Material', RelationMap::MANY_TO_ONE, array('Material_idMaterial' => 'idMaterial', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('Cessio', 'Cessio', RelationMap::MANY_TO_ONE, array('cessio_id' => 'cessio_id', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
