...
class OptionsTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.OptionsTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addPrimaryKey('OPTION_ID', 'OptionId', 'VARCHAR', true, 30, null);
		$this->addPrimaryKey('SITE_ID', 'SiteId', 'TINYINT', true, 4, null);
		$this->addColumn('VALOR', 'Valor', 'LONGVARCHAR', true, null, null);
		// validators
	} // initialize()
