...
class UsuarisllistesMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('LLISTES_IDLLISTES', 'LlistesIdllistes', 'INTEGER', 'llistes', 'IDLLISTES', true, 11);

		$tMap->addForeignKey('USUARIS_USUARISID', 'UsuarisUsuarisid', 'INTEGER', 'usuaris', 'USUARIID', true, 11);
