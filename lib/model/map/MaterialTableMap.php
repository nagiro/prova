...
class MaterialTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('IDENTIFICADOR_COMPTABLE', 'IdentificadorComptable', 'LONGVARCHAR', false, null, null);
		...
		$this->addColumn('PROVEIDOR', 'Proveidor', 'LONGVARCHAR', false, null, null);
		$this->addColumn('PREU', 'Preu', 'FLOAT', false, null, null);
		$this->addColumn('AMORTITZACIO', 'Amortitzacio', 'FLOAT', false, null, null);
		$this->addColumn('VIDA_UTIL', 'VidaUtil', 'SMALLINT', false, 6, null);
		...
		$this->addColumn('ISTRANSFERIBLE', 'Istransferible', 'TINYINT', false, 1, null);
		$this->addColumn('ISADMINISTRATIU', 'Isadministratiu', 'TINYINT', false, 1, null);
	...
	{
    $this->addRelation('Materialgeneric', 'Materialgeneric', RelationMap::MANY_TO_ONE, array('MaterialGeneric_idMaterialGeneric' => 'idMaterialGeneric', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('Cessiomaterial', 'Cessiomaterial', RelationMap::ONE_TO_MANY, array('idMaterial' => 'Material_idMaterial', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('Horarisespais', 'Horarisespais', RelationMap::ONE_TO_MANY, array('idMaterial' => 'Material_idMaterial', ), 'SET NULL', 'SET NULL');
	} // buildRelations()
