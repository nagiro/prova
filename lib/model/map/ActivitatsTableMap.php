...
class ActivitatsTableMap extends TableMap {
	...
	{
    $this->addRelation('Cicles', 'Cicles', RelationMap::MANY_TO_ONE, array('Cicles_CicleID' => 'CicleID', ), 'CASCADE', 'CASCADE');
    $this->addRelation('Tipusactivitat', 'Tipusactivitat', RelationMap::MANY_TO_ONE, array('TipusActivitat_idTipusActivitat' => 'idTipusActivitat', ), 'CASCADE', 'CASCADE');
    $this->addRelation('Horaris', 'Horaris', RelationMap::ONE_TO_MANY, array('ActivitatID' => 'Activitats_ActivitatID', ), 'CASCADE', 'CASCADE');
    $this->addRelation('Tasques', 'Tasques', RelationMap::ONE_TO_MANY, array('ActivitatID' => 'Activitats_ActivitatID', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
