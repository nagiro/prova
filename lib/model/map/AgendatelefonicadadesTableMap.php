...
class AgendatelefonicadadesTableMap extends TableMap {
	...
	{
    $this->addRelation('Agendatelefonica', 'Agendatelefonica', RelationMap::MANY_TO_ONE, array('AgendaTelefonica_AgendaTelefonicaID' => 'AgendaTelefonicaID', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
