...
class CiclesTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('EXTINGIT', 'Extingit', 'TINYINT', true, 1, 0);
		$this->addColumn('VISIBLEWEB', 'Visibleweb', 'TINYINT', true, 1, 0);
	...
	{
    $this->addRelation('Activitats', 'Activitats', RelationMap::ONE_TO_MANY, array('CicleID' => 'Cicles_CicleID', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
