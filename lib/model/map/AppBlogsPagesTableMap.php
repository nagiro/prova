...
class AppBlogsPagesTableMap extends TableMap {
    ...
    $this->addRelation('AppBlogsEntries', 'AppBlogsEntries', RelationMap::ONE_TO_MANY, array('id' => 'page_id', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('AppBlogsMenu', 'AppBlogsMenu', RelationMap::ONE_TO_MANY, array('id' => 'page_id', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
