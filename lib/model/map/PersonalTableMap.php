...
class PersonalTableMap extends TableMap {
	...
	{
    $this->addRelation('UsuarisRelatedByIdusuari', 'Usuaris', RelationMap::MANY_TO_ONE, array('idUsuari' => 'UsuariID', ), 'RESTRICT', 'CASCADE');
    $this->addRelation('UsuarisRelatedByUsuariupdateid', 'Usuaris', RelationMap::MANY_TO_ONE, array('usuariUpdateId' => 'UsuariID', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
