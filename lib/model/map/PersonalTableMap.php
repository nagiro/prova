...
class PersonalTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('TREBALLA', 'Treballa', 'TINYINT', false, 1, null);
		$this->addColumn('FEINES', 'Feines', 'LONGVARCHAR', false, null, null);
		$this->addColumn('HORARI', 'Horari', 'LONGVARCHAR', false, null, null);
		$this->addColumn('MISSATGE', 'Missatge', 'LONGVARCHAR', false, null, null);
		$this->addColumn('DATA_REVISIO', 'DataRevisio', 'DATE', false, null, null);
