...
class ReservaespaisTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('EXEMPCIO', 'Exempcio', 'TINYINT', false, 1, 0);
		$this->addColumn('PRESSUPOST', 'Pressupost', 'TINYINT', false, 1, 0);
		$this->addColumn('COLABORACIOCCG', 'Colaboracioccg', 'TINYINT', false, 1, 0);
