...
class AgendatelefonicaTableMap extends TableMap {
	...
	{
    $this->addRelation('Agendatelefonicadades', 'Agendatelefonicadades', RelationMap::ONE_TO_MANY, array('AgendaTelefonicaID' => 'AgendaTelefonica_AgendaTelefonicaID', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
