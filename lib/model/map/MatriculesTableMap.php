...
class MatriculesTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('IDDADESBANCARIES', 'Iddadesbancaries', 'INTEGER', false, 11, null);
		$this->addColumn('TUTOR_DNI', 'TutorDni', 'LONGVARCHAR', false, null, null);
		$this->addColumn('TUTOR_NOM', 'TutorNom', 'LONGVARCHAR', false, null, null);
		// validators
	} // initialize()
