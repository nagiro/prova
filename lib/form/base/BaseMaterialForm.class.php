...
abstract class BaseMaterialForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'Identificador_comptable'           => new sfWidgetFormTextarea(),
      ...
      'Proveidor'                         => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'Vida_util'                         => new sfValidatorInteger(array('min' => -32768, 'max' => 32767, 'required' => false)),
