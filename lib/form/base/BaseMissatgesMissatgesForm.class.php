...
/**
 * MissatgesMissatges form base class.
 *
 * @method MissatgesMissatges getObject() Returns the current form's model object
 *
 * @package    intranet
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseMissatgesMissatgesForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('missatges_missatges[%s]');
