...
class ActivitatsTextosForm extends sfFormPropel
{
  public function setup()
  {
    ...
    $this->setWidgets(array(
      ...
      'Imatge'                          => new sfWidgetFormInputFileEditableMy(array('file_src'=>sfConfig::get('sf_webroot').'/images/noticies/'.$this->getObject()->getImatge() , 'is_image'=>true,'with_delete'=>false)),
