...
class ClientReservesForm extends sfFormPropel
{
  ...
  public function setup()
  {
    ...
    $this->setWidgets(array(
      ...
      'Nom'                => new sfWidgetFormInput(array(),array('style'=>'width:450px')),
      'DataActivitat'      => new sfWidgetFormInput(array(),array('style'=>'width:450px')),
      'HorariActivitat'    => new sfWidgetFormInput(array(),array('style'=>'width:450px')),
      ...
      'TipusActe'          => new sfWidgetFormInput(array(),array('style'=>'width:450px')),    
      'Representacio'      => new sfWidgetFormInput(array(),array('style'=>'width:450px')),    
      'Responsable'        => new sfWidgetFormInput(array(),array('style'=>'width:450px')),
      'Organitzadors'      => new sfWidgetFormInput(array(),array('style'=>'width:450px')),
      'PersonalAutoritzat' => new sfWidgetFormInput(array(),array('style'=>'width:450px')),    
      'PrevisioAssistents' => new sfWidgetFormInput(array(),array('style'=>'width:450px')),
